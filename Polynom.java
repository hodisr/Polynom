...
public class Polynom implements Comparable<Polynom>{
    ...
    public Hashtable<Integer, Variable> getPoly(){
    ...
    public int compareTo(Polynom other){
        int retVal = 0;
         if (this.getMaxPower() == other.getMaxPower()){
             for (int i = this.getMaxPower(); i >= 0; i--){
                 if (this.getPoly().get(i).getVariable() > other.getPoly().get(i).getVariable())

             }
         }
         else if (this.getMaxPower() > other.getMaxPower())
                 retVal = 1;
         else
             retVal = -1;
         return retVal;
